...
class TestReader:
    ...
    def test_zxing_datamatrix_read_multi_rotated(self, resources):
        ...
        with Reader(multi_dm_image) as reader:
            barcodes = reader.zxing_read()
        expected_barcodes_coordinates = [
            [(74, 1292), (74, 1549), (331, 1549), (331, 1292)],
            [(2076, 1513), (2323, 1579), (2390, 1331), (2142, 1264)],
            [(452, 1331), (517, 1578), (766, 1511), (700, 1264)],
            [(1652, 1468), (1874, 1596), (2003, 1374), (1780, 1246)],
            [(840, 1374), (968, 1596), (1190, 1468), (1063, 1246)],
            [(1240, 1419), (1422, 1602), (1603, 1421), (1420, 1239)],
            [(331, 886), (74, 886), (74, 1143), (331, 1143)],
            [(2142, 858), (2076, 1105), (2324, 1171), (2390, 924)],
            [(700, 858), (453, 925), (518, 1171), (767, 1105)],
            [(1780, 840), (1651, 1062), (1874, 1190), (2002, 968)],
            [(1062, 840), (840, 968), (968, 1191), (1190, 1062)],
            [(1421, 834), (1239, 1016), (1419, 1197), (1602, 1014)],
            [(331, 737), (331, 480), (74, 480), (74, 737)],
            [(766, 700), (699, 452), (451, 518), (518, 766)],
            [(2390, 517), (2142, 451), (2076, 699), (2323, 765)],
            [(1190, 657), (1062, 434), (839, 562), (967, 784)],
            [(2001, 561), (1779, 433), (1651, 655), (1873, 783)],
            [(1601, 609), (1420, 428), (1238, 609), (1420, 790)],
            [(74, 331), (331, 331), (331, 74), (74, 74)],
            [(2325, 360), (2391, 112), (2143, 46), (2077, 294)],
            [(518, 360), (765, 293), (699, 45), (451, 112)],
            [(1874, 378), (2002, 156), (1780, 28), (1652, 250)],
            [(967, 378), (1190, 251), (1062, 28), (839, 157)],
            [(1421, 385), (1602, 202), (1421, 21), (1239, 203)],
        ]
        assert len(barcodes) == len(expected_barcodes_coordinates) == 24
        if self.DEBUG:
            with Image.open(multi_dm_image) as image:
