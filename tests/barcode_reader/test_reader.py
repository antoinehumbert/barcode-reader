...
class TestReader:
    ...
    def test_zxing_datamatrix_read_multi_rotated(self, resources):
        ...
        expected_barcodes_coordinates = [
            ...
            [(2076, 1513), (2323, 1579), (2390, 1331), (2142, 1265)],
            [(452, 1331), (518, 1578), (766, 1511), (699, 1263)],
            [(1652, 1469), (1874, 1596), (2002, 1375), (1779, 1246)],
            [(841, 1373), (968, 1595), (1191, 1467), (1063, 1245)],
            [(1239, 1420), (1420, 1602), (1602, 1420), (1420, 1239)],
            [(331, 886), (74, 886), (74, 1143), (331, 1143)],
            [(2142, 858), (2075, 1105), (2323, 1172), (2390, 924)],
            [(700, 858), (453, 924), (519, 1172), (767, 1105)],
            [(1779, 839), (1652, 1061), (1874, 1189), (2001, 967)],
            [(1063, 840), (840, 968), (967, 1190), (1190, 1062)],
            [(1420, 833), (1239, 1014), (1420, 1196), (1602, 1014)],
            [(331, 737), (331, 480), (74, 480), (74, 737)],
            [(766, 700), (699, 452), (451, 518), (518, 766)],
            [(2390, 517), (2142, 451), (2076, 699), (2323, 765)],
            [(1190, 657), (1063, 434), (840, 563), (967, 784)],
            [(2001, 560), (1778, 432), (1651, 655), (1874, 783)],
            [(1602, 608), (1420, 427), (1239, 608), (1420, 790)],
            [(74, 331), (331, 331), (331, 74), (74, 74)],
            [(2325, 359), (2390, 111), (2143, 45), (2076, 293)],
            [(518, 360), (765, 293), (699, 45), (451, 112)],
            [(1873, 378), (2002, 155), (1779, 27), (1652, 250)],
            [(967, 378), (1190, 250), (1062, 28), (840, 157)],
            [(1422, 384), (1603, 203), (1421, 21), (1240, 203)],
        ]
        assert len(barcodes) == len(expected_barcodes_coordinates) == 24
        if self.DEBUG:
            with Image.open(multi_dm_image) as image:
